...
<body>
<div id="container">
  <? $tit='Log de importación de puntos'; include('top.php'); ?>
  <?
   $ver = $_POST['ver'];
   $numpag = $_POST['numpag'];
   $ord = $_POST['ord'];
          ...
          <tr>
            <td bgcolor="#BBBBBB"><?
                  ...
                  // y establecer algunas variables
                     ...
                     // construir la condición de búsqueda
                       $resultadotot= mysql_query("SELECT 1 FROM log_puntos $condicion",$conexion);
