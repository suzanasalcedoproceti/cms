...
<script language="JavaScript">
  function valida() {
   document.forma.action='graba_importa_precios.php';
...
$(document).ready(function() {
  $('#file_upload').uploadify({
    ...
    'script'    : './uploadify/uploadify_precios.php',
...
//	   document.getElementById('validar').innerHTML='<input name="grabar" type="button" class="boton" onclick="valida();" value="SUBIR Y PROCESAR" />';
	   document.getElementById('validar').innerHTML='El archivo se subio de manera correcta.<br>Los precios quedaran actualizados dentro de los proximos 10 minutos.';
...
<body>
<div id="container">
	<? $tit='Importar Listas de Precios'; include('top.php'); ?>
	<div class="main">
