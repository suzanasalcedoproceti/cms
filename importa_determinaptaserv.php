...
<script language="JavaScript">
  function valida() {
   document.forma.action='graba_importa_determinaptaserv.php';
...
function upload_txt() {
  ...
  frmData.append('identificador','archivo_determinaptaserv');
  frmData.append('tipo','csv');
  frmData.append('fileext','*.csv');
  frmData.append('fileDesc','Archivos CSV');
  frmData.append('folder','/admin/imp_dptaserv');
...
<body>
<div id="container">
	<? $tit='Importar Determinta Planta Servicio'; include('top.php'); ?>
	<div class="main">
