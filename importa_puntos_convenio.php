...
<script language="JavaScript">
  function valida() {
   document.forma.action='graba_importa_puntos_convenio.php';
...
/*$(document).ready(function() {
  $('#file_upload').uploadify({
    ...
    'script'    : './uploadify/uploadify_puntos_convenio.php',
    'cancelImg' : './uploadify/cancel.png',
    'folder'    : './imp_puntos_convenio',
...
function upload_txt() {
  ...
  frmData.append('identificador','archivo_puntos_convenio');
  frmData.append('tipo','txt');
  frmData.append('fileext','*.txt');
  frmData.append('fileDesc','Archivos TXT');
  frmData.append('folder','/admin/imp_puntos_convenio');
