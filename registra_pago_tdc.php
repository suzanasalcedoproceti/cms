...
<script type="text/javascript">
  ...
  function valida() {
   if (document.forma.codigo_autorizacion.value=='') {
   	alert("Debes ingresar el código de autorización del banco ");
	document.forma.codigo_autorizacion.focus();
    return;
   }
   if (document.forma.mensaje_banco.value=='') {
   	alert("Debes ingresar el mensaje de respuesta del banco");
   ...
   document.forma.action='graba_registra_pago_tdc.php';
   document.forma.submit();
  }
</script>
</head>
        ...
        <? if ($row['envio_interior']) echo "Int: ".$row['envio_interior'];?>                </td>
          ...
          <tr>
            ...
            <? if ($row['estatus'] == '0') { ?>
              ...
              <tr>
                <td colspan="2"><strong>Por favor ingresa estos datos de para completar el pedido</strong></td>
              </tr>
              <tr>
                <td width="26%">C&oacute;digo de Autorizaci&oacute;n del Banco:</td>
                <td width="74%"><input name="codigo_autorizacion" type="text" id="codigo_autorizacion" size="20" maxlength="20" value="<?=$row['fdp_tdc_folio']." ".$row['codigo_autorizacion'];?>" /></td>
              </tr>
              <tr>
