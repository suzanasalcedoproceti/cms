...
<div id="container">
    ...
    <form action="lista_cobertura.php" method="post" name="brinca" id="brinca">
...
$rr="DELETE FROM cbertura WHERE idCobertura = '$IDcobertura'";
                if (!empty($IDcobertura) ) {  // si no está en proceso de autorización

                    $resultado= mysql_query("DELETE FROM cobertura WHERE idCobertura = $IDcobertura" ,$conexion);
                      ...
                      if ($totalRegistros > 0) {
                        ...
                        $error=TRUE; 
                        $mensaje='No se eliminó el Registro.' .$rr;
					  }
				...
				if (!$mensaje) $mensaje = "Registro eliminado".$rr;
