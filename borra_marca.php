...
<div id="container">
    ...
    <form action="lista_marca.php" method="post" name="brinca" id="brinca">
	...
	<div class="main">
      <p>
		...
		<?
                ...
                if (!empty($marca) AND empty($autorizar)) {  // si no está en proceso de autorización

                    $resultado= mysql_query("DELETE FROM marca WHERE clave = '$marca'" ,$conexion);
				...
				elseif (!empty($marca) AND !empty($autorizar))  {  // si está en proceso de autorización
					...
					$original=$row['original'];
           		    ...
           		    $resultado= mysql_query("UPDATE marca SET estatus=1 WHERE clave='$original'",$conexion);
