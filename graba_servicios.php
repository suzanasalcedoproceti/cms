...
<div id="container">
	...
	<div class="main">
      <p>
		...
		if (!empty($idservicio)) {  
			     $query = "UPDATE servicios SET tipo_servicio='$clave',descripcion='$nombre',condition_type_fisica='$condition_type_fisica',material='$material' 
            ...
            $query = "INSERT servicios (tipo_servicio, descripcion, condition_type_fisica,material) VALUES ('$clave','$nombre','$condition_type_fisica','$material')";
			$resultado= mysql_query($query,$conexion);
