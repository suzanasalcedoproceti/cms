...
$xrow=2;
$objPHPExcel->getActiveSheet()->getStyle("A$xrow:N$xrow")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
$objPHPExcel->getActiveSheet()->getStyle("A$xrow:N$xrow")->getFill()->getStartColor()->setRGB('F2F2F2');  
...
$objPHPExcel->getActiveSheet()->SetCellValue("N$xrow","Confirmacion");
$xrow++;   
...
switch ($row['oc_estatus']) {
				...
				case '9' : $estatus =  'Cancelada'; break;
			   }
$objPHPExcel->getActiveSheet()->SetCellValue("M$xrow",$estatus);
$confirmado = '';
switch ($row['confirmado']) {		
				case '0' : $confirmado = 'Sin confirmar'; break;
				case '1' : $confirmado =  'Confirmado'; break;
			   }
$objPHPExcel->getActiveSheet()->SetCellValue("N$xrow",$confirmado);
