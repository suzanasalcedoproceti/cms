...
<body>
<div id="container">
  <? $tit='Log de importación de Dashboard'; include('top.php'); ?>
  <?
   $ver = $_POST['ver'];
   $numpag = $_POST['numpag'];
   $ord = $_POST['ord'];
	...
	<div class="main">
      <form action="" method="post" name="forma" id="forma">
          ...
          <tr>
            <td bgcolor="#BBBBBB"><?
                  ...
                  // y establecer algunas variables
                     ...
                     // construir la condición de búsqueda
                       $resultadotot= mysql_query("SELECT 1 FROM log_dashboard $condicion",$conexion);
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="3">
          ...
          <?
			 $query = "SELECT * FROM log_dashboard $condicion $orden LIMIT $regini,$ver";
          ...
          <tr class="texto" valign="top" bgcolor="<? if ($color) echo '#FFFFFF'; else echo '#F4F4F2'; ?>">
            ...
            <td valign="top" bgcolor="#FFFFFF"><?= str_replace(chr(10),'<br>',$row['mensaje']); ?></td>
