...
<body>
<div id="container">
  <? $tit='Log de importación de RH'; include('top.php'); ?>
  <?
   $ver = $_POST['ver'];
   $numpag = $_POST['numpag'];
   $ord = $_POST['ord'];
	...
	<div class="main">
      <form action="" method="post" name="forma" id="forma">
          ...
          <tr>
            <td bgcolor="#BBBBBB"><?
                  ...
                  // y establecer algunas variables
                     ...
                     // construir la condición de búsqueda
                       $resultadotot= mysql_query("SELECT 1 FROM log_odc $condicion",$conexion);
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="3">
          ...
          <?
			 $query = "SELECT * FROM log_odc $condicion $orden LIMIT $regini,$ver";
