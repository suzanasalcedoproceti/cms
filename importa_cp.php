...
<script language="JavaScript">
  function valida() {
   document.forma.action='graba_importa_cp.php';
...
/*$(document).ready(function() {
  $('#file_upload').uploadify({
    ...
    'scriptData'  : {'nom_arc':'archivo_cp.txt','tipo':'txt'},
	'sizeLimit'   : 83584000,
	'auto'      : true,
