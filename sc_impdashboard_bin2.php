<?
	// SCRIPT PARA IMPORTAR DATOS PARA DASHBOARD (SAP) DE ARCHIVO TXT  /imp_dashboard/tawotd2.txt separado por |
	...
	if ($_SERVER['HTTP_HOST']=='localhost' ) {
		$nombrearchivo = './imp_dashboard/tawotd2.txt';
		$nombrearchivofull = 'd:/www/whirlpool/admin/imp_dashboard/tawotd2.txt';
		...
		$nombrearchivo = './imp_dashboard/tawotd2.txt';
		$nombrearchivofull = 'd:/inetpub/wwwroot/admin/imp_dashboard/tawotd2.txt';
...
//   	$base="wp_test";
	...
	if ($subido) {  // si se subió el archivo
		...
		$direc = $rowCFG['wwwroot']."admin/imp_dashboard/tawotd2.txt";
		...
		if ($enc>0) 
		 ...
		 // echo "<br>".$query."<br>";
		  ...
		  $direc = $rowCFG['wwwroot']."admin/imp_dashboard/tawotd2.txt";
		  $direc_bk = $rowCFG['wwwroot']."admin/imp_dashboard/backup/tawotd2.txt";
