        ...
        if ($enc_ped>0) {
            ...
            if (mysql_affected_rows()<=0) {
                ...
                $query = "SELECT * FROM detalle_pedido 
				           ...
				           AND (es_garantia=0 OR (es_garantia<>0 AND folio_garantia NOT IN (SELECT folio_garantia FROM dashboard where folio_pedido=$folio_puro)))";
...
*/
					...
					if ($rowDPED['es_garantia']) {  
						...
						$sku_garantia	= '';
						$folio_garantia = '';
						$fecha_compra_producto_garantia = '0000-00-00';
					}
