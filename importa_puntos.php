...
<script language="JavaScript">
  function valida() {
   document.forma.action='graba_importa_puntos.php';
...
/*$(document).ready(function() {
  $('#file_upload').uploadify({
    ...
    'script'    : './uploadify/uploadify_puntos.php',
...
<body>
<div id="container">
	<? $tit='Importar y Actualizar Puntos'; include('top.php'); ?>
	<div class="main">
