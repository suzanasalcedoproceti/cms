...
<script language="JavaScript">
  function valida() {
   //document.forma.action='graba_importa_puntos_flex.php';
...
/*$(document).ready(function() {
  $('#file_upload').uploadify({
    ...
    'script'    : './uploadify/uploadify_puntos_flex.php',
    'cancelImg' : './uploadify/cancel.png',
    'folder'    : './imp_puntos_eflex',
...
//	   document.getElementById('validar').innerHTML='<input name="grabar" type="button" class="boton" onclick="valida();" value="SUBIR Y PROCESAR" />';
	   document.getElementById('validar').innerHTML='El archivo se subio de manera correcta.<br>Los puntos flex quedaran actualizados dentro de los proximos 10 minutos..';
...
function upload_txt() {
  ...
  frmData.append('identificador','archivo_puntos_flex');
  frmData.append('tipo','txt');
  frmData.append('fileext','*.txt');
  frmData.append('fileDesc','Archivos TXT');
  frmData.append('folder','/admin/imp_puntos_eflex');
...
<body>
<div id="container">
	<? $tit='Importar y Actualizar Puntos Flex/PEP'; include('top.php'); ?>
	<div class="main">
