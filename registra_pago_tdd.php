...
<script type="text/javascript">
  ...
  function valida() {
   if (document.forma.codigo_autorizacion.value=='') {
   	alert("Debes ingresar el código de autorización del banco (Payworks CLABE)");
   ...
   document.forma.action='graba_registra_pago_tdd.php';
   document.forma.submit();
  }
</script>
</head>
...
<body>
<div id="container">
	<? $tit='Cambiar estatus de pedido a Pagado (PAGOS CON DEBITO)'; include('top.php'); ?>
	<div class="main">
        ...
        <? if ($row['envio_interior']) echo "Int: ".$row['envio_interior'];?>                </td>
          ...
          <tr>
            ...
            <? if ($row['estatus'] == '3') { ?>
              ...
              <tr>
                <td colspan="2"><strong>Por favor ingresa estos datos de Payworks para completar el pedido</strong></td>
              </tr>
              <tr>
                <td width="26%">C&oacute;digo de Autorizaci&oacute;n del Banco:</td>
                <td width="74%"><input name="codigo_autorizacion" type="text" id="codigo_autorizacion" size="20" maxlength="20" value="<?=$row['fdp_tdd_folio'];?>" /></td>
              </tr>
              <tr>
                <td>Mensaje del banco:</td>
