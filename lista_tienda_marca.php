<?
   ...
   if ($_POST['accion'] == 'borrar') {
   		$resultado = mysql_query("DELETE FROM tienda_marca WHERE clave = $tienda_marca LIMIT 1",$conexion);
	    $resultado = mysql_query("DELETE FROM  marca_omitida WHERE tienda_marca = $tienda_marca",$conexion);
   }
?>
...
<script language="JavaScript">
  function ir(form, Pag) {
    ...
    form.action='lista_tienda_marca.php';
    form.submit();
  }
  ...
  function borra(id) {
    document.forma.tienda_marca.value = id;
...
<body>
<div id="container">
  <? $tit='Listado de Tiendas de Marca'; include('top.php'); ?>
	<div class="main">
      <form action="" method="post" name="forma" id="forma">
            ...
            <td bgcolor="#BBBBBB"><?
                  ...
                  // y establecer algunas variables
                     ...
                     // construir la condición de búsqueda
                       ...
                       $resultadotot= mysql_query("SELECT * FROM tienda_marca $condicion",$conexion);
			  ...
			  ?>            </td>
            <td align="right" bgcolor="#BBBBBB"><input name="tienda_marca" type="hidden" id="tienda_marca" />
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="3">
          ...
          <tr class="texto" bgcolor="#F4F4F2">
            <td nowrap="nowrap"><b>Tienda</b></td>
            <td nowrap="nowrap"><b>Login</b></td>
            <td nowrap="nowrap"><b>Activa</b></td>
            <td><div align="center"><b>Acci&oacute;n</b></div></td>
          </tr>
          <?
             $resultado= mysql_query("SELECT * FROM tienda_marca $condicion $orden LIMIT $regini,$ver",$conexion);
             while ($row = mysql_fetch_array($resultado)){ 

				$tienda_marca= $row['clave'];
			    $resUSR= mysql_query("SELECT 1 FROM usuario_tienda_marca WHERE tienda_marca=$tienda_marca",$conexion);
          ...
          <tr class="texto" valign="top" bgcolor="<? if ($color) echo '#FFFFFF'; else echo '#F4F4F2'; ?>">
            ...
            <td align="center" nowrap="nowrap" bgcolor="#FFFFFF">
              <a href="abc_tienda_marca.php?tienda_marca=<?= $row['clave']; ?>"><img src="images/editar.png" alt="Editar Tienda de Marca" width="14" height="16" border="0" align="absmiddle" /></a>
