...
<div id="container">
    ...
    <form action="lista_sucursal_ocurre.php" method="post" name="brinca" id="brinca">
	...
	<div class="main">
      <p>
		...
		<?
				...
				$resultado= mysql_query("DELETE FROM sucursal_ocurre WHERE clave = $sucursal" ,$conexion);
