<?
	// SCRIPT PARA IMPORTAR DATOS PARA DASHBOARD (SAP) DE ARCHIVO TXT  /imp_dashboard/tawotd3.txt separado por |
	...
	if ($_SERVER['HTTP_HOST']=='localhost' ) {
		$nombrearchivo = './imp_dashboard/tawotd3.txt';
		$nombrearchivofull = 'd:/www/whirlpool/admin/imp_dashboard/tawotd3.txt';
		...
		$nombrearchivo = './imp_dashboard/tawotd3.txt';
		$nombrearchivofull = 'd:/inetpub/wwwroot/admin/imp_dashboard/tawotd3.txt';
...
//   	$base="wp_test";
	...
	if ($subido) {  // si se subió el archivo
		...
		$direc = $rowCFG['wwwroot']."admin/imp_dashboard/tawotd3.txt";
		...
		if ($enc>0) 
		 ...
		 // echo "<br>".$query."<br>";
		  ...
		  $direc = $rowCFG['wwwroot']."admin/imp_dashboard/tawotd3.txt";
		  $direc_bk = $rowCFG['wwwroot']."admin/imp_dashboard/backup/tawotd3.txt";
