...
while($row = mysql_fetch_assoc($resultado)){
	...
	$texto_mail = file_get_contents('e:/inetpub/wwwroot/mail/mail_seguimiento.html');
	$texto_partida =  file_get_contents('e:/inetpub/wwwroot/mail/detalle_pedido_seguimiento.html');
	$cliente = $row['cliente'];
