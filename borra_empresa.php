...
<div id="container">
    ...
    <form action="lista_empresa.php" method="post" name="brinca" id="brinca">
	...
	<div class="main">
      <p>
		...
		<?
                ...
                if (!empty($empresa) AND empty($autorizar)) {  // si no está en proceso de autorización

                    $resultado= mysql_query("DELETE FROM empresa WHERE clave = '$empresa'" ,$conexion);
				...
				elseif (!empty($empresa) AND !empty($autorizar))  {  // si está en proceso de autorización
					...
					$original=$row['original'];
           		    ...
           		    $resultado= mysql_query("UPDATE empresa SET estatus=1 WHERE clave='$original'",$conexion);
