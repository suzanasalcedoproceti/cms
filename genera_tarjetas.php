...
<script language="JavaScript">
  ...
  function valida() {
   ...
   document.forma.action='genera_tarjetas2.php';
	...
	<div class="main">
      <form action="" method="post" name="forma" id="forma">
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="texto">
          ...
          <tr>
            <td><div align="right">Cantidad de tarjetas a generar:</div></td>
            <td><select name="cantidad" class="campo" id="cantidad">
          ...
          <tr>
            <td>&nbsp;</td>
            <td><input name="grabar" type="button" class="boton" onclick="valida();" value="GENERAR TARJETAS" /></td>          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>          </tr>        </table>
    </form>    
