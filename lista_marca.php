...
<body>
<div id="container">
  <? $tit='Listado de Marcas'; include('top.php'); ?>
  <?
   $ver = $_POST['ver'];
   $numpag = $_POST['numpag'];
   $ord = $_POST['ord'];
	...
	<div class="main">
      <form action="" method="post" name="forma" id="forma">
        <table width="100%" border="0" align="center" cellpadding="7" cellspacing="0" class="texto">
          <tr>
            <td><input name="button" type="submit" class="boton_agregar" id="button" value="Agregar marca nueva" onClick="document.forma.action='abc_marca.php'; document.forma.submit();" /></td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td bgcolor="#BBBBBB"><?
                  ...
                  // y establecer algunas variables
                     ...
                     // construir la condición de búsqueda
                       ...
                       $resultadotot= mysql_query("SELECT * FROM marca $condicion",$conexion);
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="3">
          ...
          <?
             ...
             $resultado= mysql_query("SELECT * FROM marca $condicion $orden LIMIT $regini,$ver",$conexion);
             while ($row = mysql_fetch_array($resultado)){ 

				$marca= $row['clave'];
			    $resPRO= mysql_query("SELECT 1 FROM producto WHERE marca=$marca",$conexion);
          ...
          <tr class="texto" valign="top" bgcolor="<? if ($color) echo '#FFFFFF'; else echo '#F4F4F2'; ?>">
            ...
            <td align="center" nowrap="nowrap" bgcolor="#FFFFFF">
               	<a href="abc_marca.php?marca=<?= $row['clave']; ?>"><img src="images/editar.png" alt="Editar Marca" width="14" height="16" border="0" align="absmiddle" /></a>
