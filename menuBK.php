          ...
          <ul id="nav">
            ...
            <li class="sup w100">Log&iacute;stica
              <ul class="subul clearfix">
                ...
                <? if (op(9)) { ?><li><a href="lista_ciudad.php">Municipios </a></li><? } ?> 
                ...
                <? if (op(31)) { ?><li><a href="importa_precios_proy.php">Importar Listas de Precios B2B</a></li><? } ?>
              </ul>
            </li>
			<? } ?>
            ...
            <li class="sup w100">Cat&aacute;logo
              <ul class="subul clearfix">
                ...
                <li><a href="lista_coberturainstalacion.php">Cobertura instalaci&oacute;n</a></li>
              </ul>
            </li>
