...
function save_row(no)
{
 ...
 $("#showedt"+no).hide();   
    ...
    $.post("graba_precioservicioajax.php", { idprecioserv: no,idprecio: idprecio,idpreciocosto:idpreciocosto,idtiposervicio:idtiposervicio,tipo_producto:tipo_producto,subtipo_producto:subtipo_producto,cluster:cluster}, function(data)
...
<form action="" method="post" name="forma" id="forma">
        <table width="95%" border="0" align="left" cellpadding="7" cellspacing="0" class="texto">
         <tr>
            <td><input name="button" type="submit" class="boton_agregar" id="button" value="Agregar precio servicio" onClick="document.forma.action='abc_precioservicios.php'; document.forma.submit();" />&nbsp;<input name="button" type="submit" class="boton_agregar" id="button" value="Importar precios servicios" onClick="document.forma.action='importa_preciosservicios.php'; document.forma.submit();" /></td>
            <td align="right">&nbsp;</td>
          </tr>
