	...
	<div class="main">
      <p>
		...
		$cluster=$_POST['cluster']; 
            ...
            actualizaprecioservicio($idprecioserv, $idprecio,$idtiposervicio,$tipo_producto,$subtipo_producto,$cluster);			
...
function actualizaprecioservicio($idprecioserv, $idprecio,$idtiposervicio,$tipo_producto,$subtipo_producto,$cluster){
	global $mensajes_error;
	$error = null;
