...
<div id="container">
	...
	<div class="main">
      <p>
		...
		$condition_type_fisica=ucwords($_POST['condition_type_fisica']);
		$condition_type_moral=ucwords($_POST['condition_type_moral']);
		$idservicio=ucwords($_POST['idservicio']);
		$material=ucwords($_POST['material']);
   
		if (!empty($idservicio)) {  
			     $query = "UPDATE servicios SET tipo_servicio='$clave',descripcion='$nombre',condition_type_fisica='$condition_type_fisica',condition_type_moral='$condition_type_moral',material='$material' 
            ...
            $query = "INSERT servicios (tipo_servicio, descripcion, condition_type_fisica,condition_type_moral,material) VALUES ('$clave','$nombre','$condition_type_fisica','$condition_type_moral','$material')";
			$resultado= mysql_query($query,$conexion);
