...
<script language="JavaScript">
  function valida() {
   ...
   document.forma.action='graba_marca_comp.php';
...
<body>
<div id="container">
	<? $tit='Administrar Marcas de la Competencia'; include('top.php'); ?>
	<?
        ...
        if (!empty($marca)) {
          $resultado= mysql_query("SELECT * FROM comp_marca WHERE clave='$marca'",$conexion);
