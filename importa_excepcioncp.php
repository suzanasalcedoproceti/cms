...
<script language="JavaScript">
  function valida() {
   document.forma.action='graba_importa_excepcioncp.php';
...
function upload_txt() {
  ...
  frmData.append('identificador','archivo_excepcioncp');
  frmData.append('tipo','csv');
  frmData.append('fileext','*.csv');
  frmData.append('fileDesc','Archivos CSV');
  frmData.append('folder','/admin/imp_excepcioncp');
...
<body>
<div id="container">
	<? $tit='Importar Excepcion CP'; include('top.php'); ?>
	<div class="main">
