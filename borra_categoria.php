...
<div id="container">
    ...
    <form action="lista_categoria.php" method="post" name="brinca" id="brinca">
	...
	<div class="main">
      <p>
		...
		<?
                ...
                if (!empty($categoria) AND empty($autorizar)) {  // si no está en proceso de autorización

                    $resultado= mysql_query("DELETE FROM categoria WHERE clave = '$categoria'" ,$conexion);
                      ...
                      if ($totalRegistros > 0) {
                        ...
                        $error=TRUE; 
                        $mensaje='No se elimin&oacute; el Registro.';
					  }
				
				} 
				
				elseif (!empty($categoria) AND !empty($autorizar))  {  // si está en proceso de autorización
					...
					$original=$row['original'];
           		    ...
           		    $resultado= mysql_query("UPDATE categoria SET estatus=1 WHERE clave='$original'",$conexion);
