        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
          ...
          <tr class="texto" valign="top" bgcolor="<? if ($color) echo '#FFFFFF'; else echo '#F4F4F2'; ?>">
            ...
            <td bgcolor="#FFFFFF" align="center">
              ...
              <input name="cedis1" type="text" class="campo" id="idpntaa<?=$row['idDeterminacion'];?>" value="<?= $cedis1; ?>" size="10" style="display: none;" />
            </td>    
             <td bgcolor="#FFFFFF" align="center">
              <div id="idptb<?= $row['idDeterminacion']; ?>"><?= $cedis2; ?></div>
              <input name="cedis2" type="text" class="campo" id="idpntab<?=$row['idDeterminacion'];?>" value="<?= $cedis2; ?>" size="10" style="display: none;" />
            </td>       
             <td bgcolor="#FFFFFF" align="center">
              <div id="idptc<?= $row['idDeterminacion']; ?>"><?= $cedis3; ?></div>
              <input name="cedis3" type="text" class="campo" id="idpntac<?=$row['idDeterminacion'];?>" value="<?= $cedis3; ?>" size="10" style="display: none;" />
            </td>       
             <td bgcolor="#FFFFFF" align="center">
              <div id="idptd<?= $row['idDeterminacion']; ?>"><?= $cedis4; ?></div>
              <input name="ceids4" type="text" class="campo" id="idpntad<?=$row['idDeterminacion'];?>" value="<?= $cedis4; ?>" size="10" style="display: none;" />
            </td>       
             <td bgcolor="#FFFFFF" align="center">
              <div id="idpte<?= $row['idDeterminacion']; ?>"><?= $cedis5; ?></div>
              <input name="cedis5" type="text" class="campo" id="idpntae<?=$row['idDeterminacion'];?>" value="<?= $cedis5; ?>" size="10" style="display: none;" />
            </td>       
             <td bgcolor="#FFFFFF" align="center">
              <div id="idptf<?= $row['idDeterminacion']; ?>"><?= $cedis6; ?></div>
              <input name="cedis6" type="text" class="campo" id="idpntaf<?=$row['idDeterminacion'];?>" value="<?= $cedis6; ?>" size="10" style="display: none;" />
            </td>       
             <td bgcolor="#FFFFFF" align="center">
              <div id="idptg<?= $row['idDeterminacion']; ?>"><?= $cedis7; ?></div>
              <input name="cedis7" type="text" class="campo" id="idpntag<?=$row['idDeterminacion'];?>" value="<?= $cedis7; ?>" size="10" style="display: none;" />
            </td>       
             <td bgcolor="#FFFFFF" align="center">
              <div id="idpth<?= $row['idDeterminacion']; ?>"><?= $cedis8; ?></div>
              <input name="cedis8" type="text" class="campo" id="idpntah<?=$row['idDeterminacion'];?>" value="<?= $cedis8; ?>" size="10" style="display: none;" />
            </td>                         
