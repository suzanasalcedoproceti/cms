...
<script language="JavaScript">
  function valida() {
   document.forma.action='graba_importa_clasificacion.php';
...
$(document).ready(function() {
  $('#file_upload').uploadify({
    ...
    'script'    : './uploadify/uploadify_clas.php',
    ...
    'scriptData'  : {'nom_arc':'archivo_clas.txt','tipo':'txt'},
	'sizeLimit'   : 1358400,
	'auto'      : true,
...
<body>
<div id="container">
	<? $tit='Importar y Actualizar Clasificación de Productos (LOW Y LTL)'; include('top.php'); ?>
	<div class="main">
