...
/*    $base="whirlpool";
    $conexion=mysql_connect("localhost","root","Whr.Web.Soluciones@1");
...
//		  $query = "LOAD DATA LOCAL INFILE '$direc' INTO TABLE temp_precios FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 0 LINES";
