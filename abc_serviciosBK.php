...
function validaSoloTexto(cadena){
  ...
  function valida() {
   ...
   if (document.forma.clave.value.trim() == "") {
     alert("Ingresar un tipo de servicio válido.");
   ...
   document.forma.condition_type_fisica.focus();
    ...
    if (document.forma.condition_type_moral.value.trim() == "") {
     alert("Ingresar un identificador válido.");
   document.forma.condition_type_moral.focus();
     return;
   }
	...
	<div class="main">
      <form action="" method="post" name="forma" id="forma">
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="texto">
          ...
          <tr>
            <td><div align="right">Condition Type (Persona F&iacute;sica):</div></td>
          ...
          <tr>
            <td><div align="right">Condition Type (Persona Moral):</div></td>
            <td><input name="condition_type_moral" type="text" class="campo" required="required" id="condition_type_moral" style="text-transform:capitalize;" value="<?= $row['condition_type_moral']; ?>" size="40" maxlength="100"  />            </td>
          </tr>
          <tr>
