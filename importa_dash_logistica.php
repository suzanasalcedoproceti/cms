...
//	   document.getElementById('validar').innerHTML='<input name="grabar" type="button" class="boton" onclick="valida();" value="SUBIR Y PROCESAR" />';
	   document.getElementById('validar').innerHTML='El archivo se subio de manera correcta al servidor.<br>Los datos del dashboard logística estarán disponibles para actualización dentro de los proximos 10 minutos.';
