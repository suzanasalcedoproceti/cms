...
<script language="JavaScript">
  function valida() {
   document.forma.action='graba_precios_proy.php';
...
//    'scriptData'  : {'nom_arc':'cp_sepomex.txt','tipo':'txt'},
    ...
    'onSelect' : function(event,queueID,fileObj){
					...
					ext = ext.substr(ext.length-5); //gets last 4 chars (extension type)
					...
					switch (ext) {
						...
						document.getElementById('message').innerHTML="Error en tipo de archivo. Solo xlsx!";
