...
<script language="JavaScript">
  ...
  function borra(id) {
    ...
    document.forma.action='borra_usuario.php';
    document.forma.submit();
  }
</script>
</head>
	...
	<div class="main">
      <form action="" method="post" name="forma" id="forma">
        <table width="100%" border="0" align="center" cellpadding="7" cellspacing="0" class="texto">
          <tr>
            <td><input name="button" type="submit" class="boton_agregar" id="button" value="Agregar usuario nuevo" onClick="document.forma.action='abc_usuario.php'; document.forma.submit();" /></td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td bgcolor="#BBBBBB"><?
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="3">
          ...
          <tr class="texto" valign="top" bgcolor="<? if ($color) echo '#FFFFFF'; else echo '#F4F4F2'; ?>">
            ...
            <td align="center" nowrap="nowrap" bgcolor="#FFFFFF">
               	<a href="abc_usuario.php?usuario=<?= $row['clave']; ?>"><img src="images/editar.png" alt="Editar Usuario" width="14" height="16" border="0" align="absmiddle" /></a>
	       	    <? if ($row['clave']!=$_SESSION['usr_valido']) { ?><a onclick="return confirm('¿Estás seguro que deseas\nBorrar el Usuario?')" href="javascript:borra('<?= $row['clave']; ?>');"><img src="images/borrar.png" alt="Borrar Usuario" width="14" height="15" border="0" align="absmiddle" /></a>
				<? } else echo '<img src="images/borrar_off.png" width="14" height="15" align="absmiddle">'; ?></td>
            </tr>
          <?
                 } // WHILE
                 mysql_close();
