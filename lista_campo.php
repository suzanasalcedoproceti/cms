...
//	include("_checa_vars.php");
	...
	if ($accion == 'inserta') {
		...
		if ($enc<=0) {
			$query = "INSERT campo (categoria, subcategoria, orden, nombre_campo, campo_tabla, tipo, valores, es_filtro, es_comparable)
						VALUES ($categoria, $subcategoria, $xorden, '$xnombre_campo', '$xcampo_tabla', '$xtipo', '$xvalores', $xfiltro, $xcomparativo)";
	...
	if ($accion == 'graba') {
		...
		// detectar que no se repita el valor del campo_tabla en caso de F5 
		$query = "UPDATE campo SET orden = $xorden, nombre_campo='$xnombre_campo', campo_tabla= '$xcampo_tabla', 
...
<body>
<div id="container">
  <? $tit='Administraci&oacute;n de Campos'; include('top.php'); ?>
	<div class="main">
        ...
        <table width="100%" border="0" align="center" cellpadding="7" cellspacing="0" class="texto">
          <tr>
            <td><table width="500" border="0" align="center" cellpadding="2" cellspacing="0" class="texto">
              <tr>
                <td width="156"><div align="right">Categor&iacute;a:</div></td>
              ...
              <tr>
				...
				?>
                  ...
                  <?  
                    ...
                    <option value="x" selected>Sin subcategor&iacute;as</option>
				  <? } ?>
                </select></td>
              </tr>
              <tr>
