<?
   ...
   if ($_POST['accion'] == 'borrar') {
   		$resultado = mysql_query("DELETE FROM usuario_tienda_marca WHERE clave = $usuario LIMIT 1",$conexion);
   }
?>
...
<script language="JavaScript">
  function ir(form, Pag) {
    ...
    form.action='lista_usuario_tienda_marca.php';
    form.submit();
  }
  function ordena(orden) {
    document.forma.ord.value = orden;
	document.forma.numpag.value = 1;
    document.forma.action='lista_usuario_tienda_marca.php';
...
<body>
<div id="container">
  <? $tit='Listado de Usuarios de las Tiendas de Marca'; include('top.php'); ?>
  <?
   $ver = $_POST['ver'];
   $numpag = $_POST['numpag'];
   $ord = $_POST['ord'];
	...
	<div class="main">
      <form action="" method="post" name="forma" id="forma">
        <table width="100%" border="0" align="center" cellpadding="7" cellspacing="0" class="texto">
          <tr>
            <td valign="bottom"><input name="button" type="submit" class="boton_agregar" id="button" value="Agregar usuario nuevo" onClick="document.forma.action='abc_usuario_tienda_marca.php'; document.forma.submit();" /></td>
            <td><table width="500" border="0" align="center" cellpadding="2" cellspacing="0" class="texto">
              <tr>
                <td width="156"><div align="right">Tienda de Marca:</div></td>
                <td width="594"><span class="row1">
                  <select name="tienda_marca" class="campo" id="tienda_marca">
                    <option value="" selected="selected">Cualquiera...</option>
                    <?
					$resultadoTIE = mysql_query("SELECT * FROM tienda_marca ORDER BY nombre",$conexion);
					while ($rowTIE = mysql_fetch_array($resultadoTIE)) {
					  echo '<option value="'.$rowTIE['clave'].'"';
					  if ($rowTIE['clave']==$tienda_marca) echo 'selected';
          ...
          <tr>
            <td bgcolor="#BBBBBB"><?
                  ...
                  // y establecer algunas variables
					 ...
					 if ($tienda_marca) $condicion .= ' AND usuario_tienda_marca.tienda_marca = '.$tienda_marca;

                     // construir la condición de búsqueda
					   
					   $query = "SELECT * FROM usuario_tienda_marca $condicion ";
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="3">
          ...
          <tr class="texto" bgcolor="#F4F4F2">
            ...
            <td nowrap="nowrap"><strong>Tienda de marca</strong></td>
          ...
          <?
             ...
             $resultado= mysql_query("SELECT usuario_tienda_marca.*, tienda_marca.nombre AS nombre_tienda_marca 
			 							FROM usuario_tienda_marca 
										LEFT JOIN tienda_marca ON usuario_tienda_marca.tienda_marca = tienda_marca.clave 
          ...
          <tr class="texto" valign="top" bgcolor="<? if ($color) echo '#FFFFFF'; else echo '#F4F4F2'; ?>">
            ...
            <td bgcolor="#FFFFFF"><?= $row['nombre_tienda_marca']; ?></td>
            ...
            <td align="center" nowrap="nowrap" bgcolor="#FFFFFF">
               	<a href="abc_usuario_tienda_marca.php?usuario=<?= $row['clave']; ?>"><img src="images/editar.png" alt="Editar Usuario" width="14" height="16" border="0" align="absmiddle" /></a>
